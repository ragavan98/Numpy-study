...
# Generate a 1-D array containing 20 values, where each value has to be 3, 5, 7 or 9.
"""
...
print("#####     Generating a 1-D array containing 20 values, where each value has to be 3, 5, 7 or 9.     #####")
